    ...
    <div class="header">
        <div class="main-header">
            ...
            <div class="header-left">
                ...
                <a href="<?= base_url('/'); ?>" class="dark-logo">
                    ...
                    <div class="me-auto d-flex align-items-center" id="header-search">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-divide mb-0">
                                <li class="breadcrumb-item d-flex align-items-center"><a href="<?= base_url('/'); ?>"><i
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="nav-item dropdown has-arrow flag-nav me-2">
                            <a class="btn btn-menubar" data-bs-toggle="dropdown" href="javascript:void(0);"
                                role="button">
                                <img src="assets/img/icons/flag-7.svg" alt="Language" class="img-fluid">
                            </a>
                            <ul class="dropdown-menu p-2">
                                ...
                                <li>
                                    <a href="javascript:void(0);" class="dropdown-item">
                                        <img src="assets/img/icons/flag-7.svg" alt="flag" class="me-2">india
                                    </a>
                                </li>
                        ...
                        <div class="dropdown profile-dropdown">
                            ...
                            <div class="dropdown-menu p-2">
                                <div class="d-flex align-items-center bg-light rounded-1 p-2 mb-2">
                                    ...
                                    <div>
                                        <h6 class="fs-14 fw-medium mb-1">Anish Kumar</h6>
                                ...
                                <!-- Item-->
                                <a class="dropdown-item logout d-flex align-items-center" href="<?= base_url('logout'); ?>">
    ...
    <div class="two-col-sidebar" id="two-col-sidebar">
        ...
        <div class="sidebar" id="sidebar-two">
            ...
            <div class="sidebar-logo">
                <a href="<?= base_url('/'); ?>" class="logo logo-normal">
                    <img src="assets/img/logo.svg" alt="Logo">
                </a>
                ...
                <a href="<?= base_url('/'); ?>" class="dark-small">
            ...
            <div class="sidebar-inner" data-simplebar>
                <?php 
                    $uri = service('uri');
                    // Agar URL "localhost/project/new-lead" hai, to segment 1 "new-lead" hoga
                    ...
                    <ul>
                        <li>
                            <ul>
                                <li>
                                    <a href="<?= base_url(); ?>"
                                        class="<?= ($currentSegment == '' || $currentSegment == 'dashboard') ? 'active' : '' ?>">
                                        <i class="isax isax-element-45"></i><span>Dashboard</span>
                                    </a>
                                </li>
                                <?php 
                                    $isLeadsActive = ($currentSegment == 'new-lead' || $currentSegment == 'lead-list' || $currentSegment == 'lead-follow' || $currentSegment == 'lead-converter');
                                ?>
                                <li class="submenu">
                                    <a href="javascript:void(0);" class="<?= $isLeadsActive ? 'subdrop' : '' ?>">
                                        <i class="isax isax-people5"></i><span>Leads</span>
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <ul style="display: <?= $isLeadsActive ? 'block' : 'none'; ?>;">
                                        <li>
                                            <a href="<?= base_url('new-lead'); ?>"
                                                class="<?= ($currentSegment == 'new-lead') ? 'active' : '' ?>">Add New
                                                Lead</a>
                                        </li>
                                        <li>
                                            <a href="<?= base_url('lead-list'); ?>"
                                                class="<?= ($currentSegment == 'lead-list') ? 'active' : '' ?>">My Leads
                                                List</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="<?= base_url('lead-follow'); ?>">
                                        <i class="isax isax-clock5"></i><span>Follow Ups</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?= base_url('lead-converter'); ?>">
                                        <i class="isax isax-verify5"></i><span>Converted / Won</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <ul>
                                <li>
                                    <a href="<?= base_url('agent-report'); ?>">
                                        <i class="isax isax-chart-15"></i><span>Agent Performance</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?= base_url('source-report'); ?>">
                                        <i class="isax isax-chart-success5"></i><span>Source Report</span>
                                    </a>
                                </li>
                            </ul>
                        </li>

                        <li class="menu-title"><span>Team & Access</span></li>
                        <li>
                            <ul>
                                <?php 
                                    $isAgentsActive = ($currentSegment == 'user' || $currentSegment == 'role');
                                ?>

                                <li class="submenu">
                                    <a href="javascript:void(0);" class="<?= $isAgentsActive ? 'subdrop' : '' ?>">
                                        <i class="isax isax-profile-2user5"></i><span>Manage Agents</span>
                                        <span class="menu-arrow"></span>
                                    </a>

                                    <ul style="display: <?= $isAgentsActive ? 'block' : 'none'; ?>;">

                                        <li>
                                            <a href="<?= base_url('user'); ?>"
                                                class="<?= ($currentSegment == 'user') ? 'active' : '' ?>">
                                                All Users
                                            </a>
                                        </li>
                                        ...
                                        <li>
                                            <a href="<?= base_url('role'); ?>"
                                                class="<?= ($currentSegment == 'role') ? 'active' : '' ?>">
                                                Roles & Permissions
                                            </a>
                                        </li>
                        ...
                        <li>
                            <ul>
                                <?php 
                                    $isSettingsActive = ($currentSegment == 'comapny-setting' || $currentSegment == 'email-setting' || $currentSegment == 'notifications');
                                ?>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul style="display: <?= $isSettingsActive ? 'block' : 'none'; ?>;">
                                        ...
                                        <li>
                                            <a href="<?= base_url('comapny-setting'); ?>"
                                                class="<?= ($currentSegment == 'comapny-setting') ? 'active' : '' ?>">
                                                Company Profile
                                            </a>
                                        </li>

                                        <li>
                                            <a href="<?= base_url('email-setting'); ?>"
                                                class="<?= ($currentSegment == 'email-setting') ? 'active' : '' ?>">
                                                Email Config
                                            </a>
                                        </li>
                                        ...
                                        <li>
                                            <a href="<?= base_url('notifications'); ?>"
                                                class="<?= ($currentSegment == 'notifications') ? 'active' : '' ?>">
                                                Notifications
                                            </a>
                                        </li>
                                ...
                                <li>
                                    <a href="<?= base_url('logout'); ?>">
                                        <i class="isax isax-logout-15"></i><span>Logout</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
